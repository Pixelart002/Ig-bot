    ...
    async with async_playwright() as p:
        ...
        while True:
            try:
                ...
                print("[TASK 5] 🧠 Brain (Mistral) fetching new strategy...", flush=True)
                # Mistral call logic here...
                
                print("[TASK 6] 🎨 Artisan (Flux) generating visual content...", flush=True)
                # Flux call logic here...
                
                print("[SLEEP] 💤 Task finished. Resting for 5 minutes...", flush=True)
...
if __name__ == "__main__":
    ...
    print("[SERVER] 📡 Flask Health-Check Server starting on Port 8000...", flush=True)
