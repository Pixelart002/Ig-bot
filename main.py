...
def index():
    ...
    <html>
        ...
        <body>
            <h3>🧠 MANUS-AGENT: HLS STREAM</h3>
            <div class="stream-container">
                <div class="browser-ui">
                    <div class="dot" style="background: #ff5f56;"></div>
                    <div class="dot" style="background: #ffbd2e;"></div>
                    <div class="dot" style="background: #27c93f;"></div>
                    <span style="margin-left: 10px; color: #aaa; font-size: 12px;">Low-Bandwidth HLS Feed</span>
                </div>
            ...
            <script>
                ...
                // HLS.js handles the chunked packets just like YouTube
                if (Hls.isSupported()) {
                    var hls = new Hls({
...
# Serve the video packets (.ts) and playlist (.m3u8)
